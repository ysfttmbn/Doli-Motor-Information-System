                            ...
                            <div class="ltn__checkout-single-content-info">
                                <form action="{{ route('checkout.post')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-item input-item-phone ltn__custom-icon">
                                                <input type="text" name="ltn__phone" placeholder="Nomor Telepon" required value="{{ Auth::user()->nomortelepon }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="input-item">
                                                        <input required name='alamat' id='alamat' type="text" autocomplete="off" value="{{ old('alamat') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="input-item input-item-textarea ltn__custom-icon">
                                        <textarea name="ltn__message" value="{{ old('textarea') }}"></textarea>
                                    </div>
                                    <h6>Bukti Pembayaran</h6>
                                            <input required type="file" name="foto" id="foto" accept=".jpg, .jpeg, .png, .pdf">
