                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="account-login-inner">
                        <form action="{{ url('do_register') }}" method="post" class="ltn__form-box contact-form-box">
                            ...
                            <input type="text" class="form-control @error('nomortelepon') is-invalid @enderror" name="nomortelepon" placeholder="Nomor Telepon" value="{{ old('nomortelepon') }}" autocomplete="off">
